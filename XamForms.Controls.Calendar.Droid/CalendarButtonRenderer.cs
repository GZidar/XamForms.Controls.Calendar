...
namespace XamForms.Controls.Droid
{
    ...
    public class CalendarButtonRenderer : ButtonRenderer
    {
        ...
        protected void ChangeBackgroundPattern()
        {
            ...
            for (var i = 0; i < element.BackgroundPattern.Pattern.Count; i++)
            {
                ...
                {
                    d.Add(new TextDrawable(Context, bp.Color.ToAndroid()) { Pattern = bp });
                }
                else
                {
    ...
    public class TextDrawable : ColorDrawable
    {
        ...
        public TextDrawable(Context context, Android.Graphics.Color color)
            : base(color)
        {
            paint = new Paint();
        ...
        public override void Draw(Canvas canvas)
        {
            ...
            paint.TextSize = Android.Util.TypedValue.ApplyDimension(Android.Util.ComplexUnitType.Sp, 
                Pattern.TextSize > 0 ? Pattern.TextSize : 12, 
